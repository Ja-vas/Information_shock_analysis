...
This project is a quantitative study of stock prices reaction to sudden information shocks. It specifically looks at **significant gaps** (with higher than average pre-market volume) and tests whether the market underreacts to the news behind them.
